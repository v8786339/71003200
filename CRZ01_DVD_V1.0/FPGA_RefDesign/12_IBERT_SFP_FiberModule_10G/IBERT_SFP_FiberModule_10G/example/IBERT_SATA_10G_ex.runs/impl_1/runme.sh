...
HD_PWD='E:/workspace/KXZ7C01/ProductCD/IBERT_SATA_10G/example/IBERT_SATA_10G_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_IBERT_SATA_10G.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_IBERT_SATA_10G.tcl -notrace
