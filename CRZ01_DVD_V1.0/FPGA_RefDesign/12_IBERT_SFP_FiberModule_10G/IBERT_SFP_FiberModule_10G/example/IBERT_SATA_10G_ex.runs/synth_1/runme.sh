...
HD_PWD='E:/workspace/KXZ7C01/ProductCD/IBERT_SATA_10G/example/IBERT_SATA_10G_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_IBERT_SATA_10G.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_IBERT_SATA_10G.tcl
