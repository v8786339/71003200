...
#
# Generated by export_simulation on Sat Jan 25 14:45:46 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './IBERT_SATA_10G.sh' script.

./IBERT_SATA_10G.sh -reset_run
...
./IBERT_SATA_10G.sh -noclean_files

For more information on the script, please type './IBERT_SATA_10G.sh -help'.
