...
HD_PWD='D:/BaiduNetdiskDownload/crz01/CRZ01_DVD_V1.0/CRZ01_DVD_V1.0/CRZ01_DVD_V1.0/FPGA_RefDesign/21_Preload/SoC_HDMI/SoC_HDMI/PS_Embedded_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log embedded_design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source embedded_design.tcl -notrace
