...
HD_PWD='D:/BaiduNetdiskDownload/crz01/CRZ01_DVD_V1.0/CRZ01_DVD_V1.0/CRZ01_DVD_V1.0/FPGA_RefDesign/21_Preload/SoC_HDMI/SoC_HDMI/PS_Embedded_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log embedded_design.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source embedded_design.tcl
