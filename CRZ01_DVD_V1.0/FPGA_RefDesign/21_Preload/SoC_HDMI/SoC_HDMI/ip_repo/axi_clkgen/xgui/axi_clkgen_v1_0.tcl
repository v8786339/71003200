...
proc init_gui { IPINST } {
	...
	set PCORE_CLK1_DIV [ipgui::add_param $IPINST -parent $Page0 -name PCORE_CLK1_DIV]
	set PCORE_CLK0_DIV [ipgui::add_param $IPINST -parent $Page0 -name PCORE_CLK0_DIV]
	set PCORE_VCO_MUL [ipgui::add_param $IPINST -parent $Page0 -name PCORE_VCO_MUL]
	set PCORE_VCO_DIV [ipgui::add_param $IPINST -parent $Page0 -name PCORE_VCO_DIV]
	set PCORE_CLKIN_PERIOD [ipgui::add_param $IPINST -parent $Page0 -name PCORE_CLKIN_PERIOD]
