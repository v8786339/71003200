...
proc init_gui { IPINST } {
	...
	set PCORE_EMBEDDED_SYNC [ipgui::add_param $IPINST -parent $Page0 -name PCORE_EMBEDDED_SYNC]
	set PCORE_DEVICE_TYPE [ipgui::add_param $IPINST -parent $Page0 -name PCORE_DEVICE_TYPE]
	set PCORE_Cr_Cb_N [ipgui::add_param $IPINST -parent $Page0 -name PCORE_Cr_Cb_N]
