...
HD_PWD='E:/workspace/KXZ7C01/DDR3_Mem_900MHz/vivado_proj/ddr3_memtest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestDemo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestDemo.tcl -notrace
