...
HD_PWD='E:/workspace/KXZ7C01/DDR3_Mem_900MHz/vivado_proj/ddr3_memtest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestDemo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestDemo.tcl
