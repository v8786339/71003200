...
#
# Generated by export_simulation on Tue Jan 21 00:05:24 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ps_subsys.sh' script.

./ps_subsys.sh -reset_run
...
./ps_subsys.sh -noclean_files

For more information on the script, please type './ps_subsys.sh -help'.
